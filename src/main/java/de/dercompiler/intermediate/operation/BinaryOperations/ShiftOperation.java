...
public class ShiftOperation extends BinaryOperation {
    public ShiftOperation(OperationType operationType,Operand definition, Operand target, Operand source, boolean isMemoryOperation) {
        super(operationType, definition, target, source, isMemoryOperation);
