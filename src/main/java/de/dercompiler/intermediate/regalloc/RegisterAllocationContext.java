...
public record RegisterAllocationContext(EnumSet<X86Register> avalableRegisters, EnumSet<X86Register> spillRegisters, VariableLifetimeTable vlt, FunctionSplitView splitview, CallingConvention convention) {
}
