...
public record RegisterAllocationContext(EnumSet<X86Register> avalableRegisters, EnumSet<X86Register> spareRegisters, EnumSet<X86Register> usedRegisters, VariableLifetimeTable vlt, FunctionSplitView splitview, CallingConvention convention) {
}
