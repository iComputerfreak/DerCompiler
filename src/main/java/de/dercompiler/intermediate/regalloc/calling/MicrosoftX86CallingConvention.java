...
public class MicrosoftX86CallingConvention extends CallingConvention{
    ...
    public MicrosoftX86CallingConvention() {
        super(X86Register.RAX,
                ...
                /* scratch */   new X86Register[]{X86Register.R10, X86Register.R11},
                /* save */      new X86Register[]{X86Register.RBX, X86Register.RBP, X86Register.RDI, X86Register.RSI, X86Register.RSP, X86Register.R12, X86Register.R13, X86Register.R14, X86Register.R15}
        );
    }
}
