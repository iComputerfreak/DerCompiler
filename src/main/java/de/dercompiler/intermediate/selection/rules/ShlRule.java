...
public class ShlRule extends SubstitutionRule<Shl> {
    ...
    public List<Operation> substitute() {
        Operation shl = new de.dercompiler.intermediate.operation.BinaryOperations.Shl(new VirtualRegister(), getLeft().getTarget(), getRight().getTarget(), isMemoryOperation());
        return List.of(shl);
    }
