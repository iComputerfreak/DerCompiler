...
public enum PassErrorIds implements IErrorIds {
    ...
    DUPLICATE_CLASS(708),
    SPECS_VIOLATION(709),
    ILLEGAL_ARRAY_ACCESS(710),
    ILLEGAL_ASSIGNMENT(711),
    UNKNOWN_TYPE(712),
    DUPLICATE_VARIABLE(713),
    DUPLICATE_FIELD(714),
    DUPLICATE_METHOD(715),
    ILLEGAL_FIELD_TYPE(716),
    ILLEGAL_PARAMETER_TYPE(717),
    ILLEGAL_INTERNAL_REFERENCE(718),
    ILLEGAL_ARRAY_TYPE(719);
