...
public class LibraryMethods {
    ...
    public static final Entity alloc;
    ...
    static {
        ...
        alloc = new Entity(null, "alloc", new MethodType(new Type[]{new PointerType(FirmTypes.voidFirmType)}, new Type[]{FirmTypes.intFirmType}));

        map = new HashMap<>(5);
        List.of(print_int, print_byte, read_byte, flush_out, alloc).stream().forEach(entity -> map.put(entity.getName(), entity));
    }
